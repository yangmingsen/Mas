...
import top.yms.mas.entity.AliExpendOtherExample.Criteria;
import top.yms.mas.entity.AliExpendOtherExample.Criterion;
...
public class AliExpendOtherSqlProvider {

    public String countByExample(AliExpendOtherExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(AliExpendOtherExample example) {
        BEGIN();
        DELETE_FROM("ali_expend_other");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AliExpendOther record) {
        BEGIN();
        INSERT_INTO("ali_expend_other");
    ...
    public String selectByExample(AliExpendOtherExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AliExpendOther record = (AliExpendOther) parameter.get("record");
        AliExpendOtherExample example = (AliExpendOtherExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AliExpendOther record) {
        BEGIN();
        UPDATE("ali_expend_other");
    ...
    protected void applyWhere(AliExpendOtherExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
