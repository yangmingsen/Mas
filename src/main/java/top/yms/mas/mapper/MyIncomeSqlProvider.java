...
import top.yms.mas.entity.MyIncomeExample.Criteria;
import top.yms.mas.entity.MyIncomeExample.Criterion;
import top.yms.mas.entity.MyIncomeExample;

public class MyIncomeSqlProvider {

    public String countByExample(MyIncomeExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("my_income");
    ...
    public String deleteByExample(MyIncomeExample example) {
        BEGIN();
        DELETE_FROM("my_income");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(MyIncome record) {
        BEGIN();
        INSERT_INTO("my_income");
    ...
    public String selectByExample(MyIncomeExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        MyIncome record = (MyIncome) parameter.get("record");
        MyIncomeExample example = (MyIncomeExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(MyIncome record) {
        BEGIN();
        UPDATE("my_income");
    ...
    protected void applyWhere(MyIncomeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
