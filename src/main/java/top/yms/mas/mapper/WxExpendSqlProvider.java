...
import top.yms.mas.entity.WxExpendExample.Criteria;
import top.yms.mas.entity.WxExpendExample.Criterion;
...
public class WxExpendSqlProvider {

    public String countByExample(WxExpendExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("wx_expend");
    ...
    public String deleteByExample(WxExpendExample example) {
        BEGIN();
        DELETE_FROM("wx_expend");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(WxExpend record) {
        BEGIN();
        INSERT_INTO("wx_expend");
    ...
    public String selectByExample(WxExpendExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WxExpend record = (WxExpend) parameter.get("record");
        WxExpendExample example = (WxExpendExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(WxExpend record) {
        BEGIN();
        UPDATE("wx_expend");
    ...
    protected void applyWhere(WxExpendExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
