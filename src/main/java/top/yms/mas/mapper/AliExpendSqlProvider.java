...
import top.yms.mas.entity.AliExpendExample.Criteria;
import top.yms.mas.entity.AliExpendExample.Criterion;
...
public class AliExpendSqlProvider {

    public String countByExample(AliExpendExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("ali_expend");
    ...
    public String deleteByExample(AliExpendExample example) {
        BEGIN();
        DELETE_FROM("ali_expend");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AliExpend record) {
        BEGIN();
        INSERT_INTO("ali_expend");
    ...
    public String selectByExample(AliExpendExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AliExpend record = (AliExpend) parameter.get("record");
        AliExpendExample example = (AliExpendExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AliExpend record) {
        BEGIN();
        UPDATE("ali_expend");
    ...
    protected void applyWhere(AliExpendExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
