...
import top.yms.mas.entity.WxExpendOtherExample.Criteria;
import top.yms.mas.entity.WxExpendOtherExample.Criterion;
...
public class WxExpendOtherSqlProvider {

    public String countByExample(WxExpendOtherExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(WxExpendOtherExample example) {
        BEGIN();
        DELETE_FROM("wx_expend_other");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(WxExpendOther record) {
        BEGIN();
        INSERT_INTO("wx_expend_other");
    ...
    public String selectByExample(WxExpendOtherExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WxExpendOther record = (WxExpendOther) parameter.get("record");
        WxExpendOtherExample example = (WxExpendOtherExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(WxExpendOther record) {
        BEGIN();
        UPDATE("wx_expend_other");
    ...
    protected void applyWhere(WxExpendOtherExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
