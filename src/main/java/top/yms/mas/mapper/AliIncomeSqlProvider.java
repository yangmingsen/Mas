...
import top.yms.mas.entity.AliIncomeExample.Criteria;
import top.yms.mas.entity.AliIncomeExample.Criterion;
...
public class AliIncomeSqlProvider {

    public String countByExample(AliIncomeExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("ali_income");
    ...
    public String deleteByExample(AliIncomeExample example) {
        BEGIN();
        DELETE_FROM("ali_income");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AliIncome record) {
        BEGIN();
        INSERT_INTO("ali_income");
    ...
    public String selectByExample(AliIncomeExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AliIncome record = (AliIncome) parameter.get("record");
    ...
    public String updateByPrimaryKeySelective(AliIncome record) {
        BEGIN();
        UPDATE("ali_income");
    ...
    protected void applyWhere(AliIncomeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
